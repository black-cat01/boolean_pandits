...
//                         <input type="text" class="form-control input-sm" placeholder="enrol ID" onChange={(e)=>{this.setState({idnumber:e.target.value})}} /> <br /><br />
//                         <input type="password" class="form-control input-sm" placeholder="Password" onChange={(e)=>{this.setState({password:e.target.value})}} /> <br /><br />
//                         <button type="submit" class="btn btn-secondary btn-block" onClick={this.login.bind(this)} style={{margin:'3px'}}>Login</button>
...
//                         <button type="text" class="btn btn-secondary btn-block" style={{marginTop:'15px'}} onClick={this.register.bind(this)}>register</button>
//                         <button type="text" class="btn btn-outline-secondary btn-sm float-right" style={{marginTop:'15px'}} onClick={()=> this.setState({isRegister: false})}>Go to Login</button>
